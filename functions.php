...
function sfl_scripts_and_styles() {
  ...
  wp_enqueue_style( 'nav', get_stylesheet_directory_uri().'/css/nav.css', array('style'));

  if ( is_front_page() ) {
    wp_enqueue_style( 'img_top', get_template_directory_uri().'/css/img-top.css', array('style') );
    wp_enqueue_style( 'front', get_template_directory_uri().'/css/front.css', array('style') );
  }
}
